...
<head>
	...
	<title>Akun Saya | PPDB SMAK Yos Sudarso Batu</title>
    ...
    <div class="wrapper">
        ...
        <nav class="navbar navbar-static-top">
            ...
            <ul class="nav navbar-nav">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <span class="hidden-xs"><?=ucwords($this->session->user['name'])?></span>
                </a>
                <ul class="dropdown-menu">
                    ...
                    <p>
                        <?=ucwords($this->session->user['name'])?>
                    </p>
                    </li>
                    <!-- Menu Footer-->
                    ...
                    <div class="pull-right">
                        <a href="<?=base_url('dataprocess/ppdblogout')?>" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                    </li>
                </ul>
                </li>
        ...
        <aside class="main-sidebar">
            ...
            <div class="user-panel">
                ...
                <p><?=explode(" " , ucwords($this->session->user['name']))[0]?></p>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                    <a href="<?=base_url()?>ppdb/myaccount">
                        <i class="fa fa-home"></i> <span>Beranda</span>
                    </a>
                </li>
                <li>
                    <a href="<?=base_url()?>ppdb/myaccount/profile">
                        <i class='fa fa-user'></i> <span>Data diri</span>
                    </a>
                </li>     
                <li>
                    <a href="<?=base_url()?>ppdb/myaccount/data">
                        <i class='fa fa-file-text'></i> <span>Biodata & Nilai</span>
                    </a>
                </li>    
            </ul>
            </section>
