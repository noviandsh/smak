jQuery.extend({
	...
	dobPicker: function (params) {
		...
		// set days
		dayElement.append("<option disabled selected value=\"\">" + params.dayDefault + "</option>");
		for (var i = 1; i <= 31; i++) {
			var day = "" + i;
			var value = i > 9 ? "" + i : "0" + i;
		...
		monthElement.append("<option disabled selected value=\"\">" + params.monthDefault + "</option>");
		for (var i = 1; i <= 12; i++) {
		...
		yearElement.append("<option disabled selected value=\"\">" + params.yearDefault + "</option>");
